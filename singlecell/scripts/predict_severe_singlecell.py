...
def regenerate_datasets(ds):
    ...
    for ct in ['T cell', 'B cell', 'NK cell', 'NKT cell', 'monocyte', 'pDC', 'cDC']:
        print(ct)
...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    fig.savefig('../../data/supplementary_fig12.png', dpi=600)
    fig.savefig('../../data/supplementary_fig12.svg')

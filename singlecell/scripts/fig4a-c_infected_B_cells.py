...
if __name__ == '__main__':
    ...
    ax = axs[1]
    data = dss.query_samples_by_metadata('cellType != "unknown"').samplesheet[
            ['cellType', 'log_virus_reads_per_million']]
    sns.violinplot(
    ...
    ax.set_ylabel('dimension 2')
    plt.tight_layout()
    #fig.savefig('../../figures/supplementary_fig5.svg')
    #fig.savefig('../../figures/supplementary_fig5.png')
    ...
    #fig.savefig('../../figures/supplementary_fig7.svg')
    #fig.savefig('../../figures/supplementary_fig7.png')
